<template>
  <div
    class="flex min-h-screen bg-gray-100 relative items-top justify-center sm:items-center dark:bg-gray-900 sm:pt-0"
  >
    <div v-if="canLogin" class="py-4 px-6 top-0 right-0 hidden fixed sm:block">
      <inertia-link
      ...
      <template v-else>
        ...
        <inertia-link
          v-if="canRegister"
          :href="route('register')"
          class="text-sm ml-4 text-gray-700 underline"
        >
          Register
        </inertia-link>
      </template>
    ...
    <div class="mx-auto max-w-6xl sm:px-6 lg:px-8">
      <div class="flex pt-8 justify-center sm:justify-start sm:pt-0">
        <svg
          viewBox="0 0 651 192"
          fill="none"
      ...
      <div class="bg-white shadow mt-8 overflow-hidden sm:rounded-lg dark:bg-gray-800">
        <div class="grid grid-cols-1 md:grid-cols-2">
          ...
          <div class="border-t border-gray-200 p-6 md:border-l dark:border-gray-700 md:border-t-0">
            <div class="flex items-center">
              <svg
                fill="none"
                stroke="currentColor"
          ...
          <div class="border-t border-gray-200 p-6 md:border-l dark:border-gray-700">
            <div class="flex items-center">
              ...
              <div class="font-semibold text-lg ml-4 text-gray-900 leading-7 dark:text-white">
                Vibrant Ecosystem
              </div>
            </div>
      ...
      <div class="flex mt-4 justify-center sm:items-center sm:justify-between">
        <div class="text-center text-sm text-gray-500 sm:text-left">
          <div class="flex items-center">
            <svg
              ...
              viewBox="0 0 24 24"
              stroke="currentColor"
              class="-mt-px h-5 text-gray-400 w-5"
            >
              <path
            ...
            <svg
              ...
              stroke-width="2"
              viewBox="0 0 24 24"
              class="-mt-px h-5 ml-4 text-gray-400 w-5"
            >
              <path
        ...
        <div class="text-center text-sm ml-4 text-gray-500 sm:text-right sm:ml-0">
