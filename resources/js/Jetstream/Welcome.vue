<template>
  <div>
    <div class="bg-white border-b border-gray-200 p-6 sm:px-20">
      <div>
        <ApplicationLogo class="h-12 w-auto block" />
      </div>
    ...
    <div class="bg-gray-200 bg-opacity-25 grid grid-cols-1 md:grid-cols-2">
      <div class="p-6">
        <div class="flex items-center">
          ...
          <div class="font-semibold text-lg ml-4 text-gray-600 leading-7">
        ...
        <div class="ml-12">
          ...
          <a href="https://laravel.com/docs">
            <div class="flex font-semibold mt-3 text-sm text-indigo-700 items-center">
      ...
      <div class="border-t border-gray-200 p-6 md:border-l">
        <div class="flex items-center">
          ...
          <div class="font-semibold text-lg ml-4 text-gray-600 leading-7">Authentication</div>
        </div>
